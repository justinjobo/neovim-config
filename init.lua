...
vim.g.guifont = "JetBrainsMono Nerd Font:h14" -- Adjust the font size as needed
...
vim.api.nvim_create_autocmd("VimEnter", {
	callback = function()
		-- Override standard Comment group
		vim.api.nvim_set_hl(0, "Comment", { fg = "#a3a5a6", italic = false })
		-- Override Treesitter comment group
		vim.api.nvim_set_hl(0, "@comment", { fg = "#a3a5a6", italic = false })
	end,
})
...
require("lazy").setup({
	...
	{ -- You can easily change to a different colorscheme.
		...
		init = function()
			...
			-- Set termguicolors and colorscheme
	...
	},
	{
		...
		dependencies = {
			"nvim-treesitter/playground", -- Add playground as a dependency
		},
		opts = {
			ensure_installed = {
				"bash",
			...
			-- Enable the playground extension
			playground = {
				enable = true,
				disable = {},
